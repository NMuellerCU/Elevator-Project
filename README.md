...
## Description
This program calculates the amount of time it takes for an elevator to travel between a list of floors, starting at the floor marked by 'start='. In our case the elevators speed is 10 seconds/floor.
## Inputs
